...
//1251669/1898524/2.50/5/4/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "TLV75533PDBVR" (originalName "TLV75533PDBVR")
	...
	(compDef "TLV75533PDBVR" (originalName "TLV75533PDBVR") (compHeader (numPins 5) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "TLV75533PDBVR"))
		...
		(attr "Manufacturer_Part_Number" "TLV75533PDBVR")
		(attr "Mouser Part Number" "595-TLV75533PDBVR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/TLV75533PDBVR?qs=55YtniHzbhAKEwqeO2xJXQ%3D%3D")
		(attr "Arrow Part Number" "TLV75533PDBVR")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/tlv75533pdbvr/texas-instruments?utm_currency=USD&region=nac")
		(attr "Description" "LDO Voltage Regulators 500-mA, Low IQ, Small Size, Low Dropout Regulator 5-SOT-23 -40 to 125")
		(attr "<Hyperlink>" "http://www.ti.com/lit/gpn/tlv755p")
		(attr "<Component Height>" "1.45")
		(attr "<STEP Filename>" "TLV75533PDBVR.stp")
