...
//804162/1898524/2.50/8/4/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "W25Q128JVSIM_TR" (originalName "W25Q128JVSIM_TR")
	...
	(compDef "W25Q128JVSIM_TR" (originalName "W25Q128JVSIM_TR") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "W25Q128JVSIM_TR"))
		...
		(attr "Manufacturer_Part_Number" "W25Q128JVSIM TR")
		(attr "Mouser Part Number" "454-W25Q128JVSIMTR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Winbond/W25Q128JVSIM-TR?qs=qSfuJ%252Bfl%2Fd6ji9IuruL6Zg%3D%3D")
		(attr "Arrow Part Number" "W25Q128JVSIM TR")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/w25q128jvsimtr/winbond-electronics?utm_currency=USD&region=nac")
		(attr "Description" "3V 128M-BIT SERIAL FLASH MEMORY WITH DUAL/QUAD SPI & QPI & DTR")
		(attr "<Hyperlink>" "http://www.winbond.com/resource-files/w25q128jv%20dtr%20revb%2011042016.pdf")
		(attr "<Component Height>" "2.16")
		(attr "<STEP Filename>" "W25Q128JVSIM_TR.stp")
